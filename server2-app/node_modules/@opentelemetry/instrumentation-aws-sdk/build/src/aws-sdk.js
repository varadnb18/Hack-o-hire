...
class AwsInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    unpatchV2(moduleExports) {
        if ((0, instrumentation_1.isWrapped)(moduleExports?.Request.prototype.send)) {
            this._unwrap(moduleExports.Request.prototype, 'send');
        }
        if ((0, instrumentation_1.isWrapped)(moduleExports?.Request.prototype.promise)) {
    ...
    _startAwsV2Span(request, metadata, normalizedRequest) {
        ...
        const newSpan = this.tracer.startSpan(name, {
            ...
            attributes: {
                ...
                [enums_1.AttributeNames.AWS_SIGNATURE_VERSION]: service?.config?.signatureVersion,
                [enums_1.AttributeNames.AWS_SERVICE_API]: service?.api?.className,
                [enums_1.AttributeNames.AWS_SERVICE_IDENTIFIER]: serviceIdentifier,
                [enums_1.AttributeNames.AWS_SERVICE_NAME]: service?.api?.abbreviation,
                ...(0, utils_1.extractAttributesFromNormalizedRequest)(normalizedRequest),
                ...metadata.spanAttributes,
            },
        });
        ...
        return function (_handler, awsExecutionContext) {
            ...
            const patchedHandler = function (command) {
                ...
                const serviceName = clientConfig?.serviceId ??
                    (0, utils_1.removeSuffixFromStringIfExists)(awsExecutionContext.clientName, 'Client');
